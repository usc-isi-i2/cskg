...
def main():
    ...
    raw_config = get_config(entity_path=output_path,edge_paths=edge_paths,checkpoint_path=checkpoint_path,
        entities_structure=entities,relation_structure=relations,dynamic_relations=args.dr,
        dimension=args.dimiension,global_emb=False,comparator=args.comparator,              
        init_scale=args.init_scale,bias=args.bias,num_epochs=args.num_epochs,num_uniform_negs=1000,loss_fn=args.loss_fn,lr=args.lr,regularization_coef=1e-3,
        eval_fraction=0)
